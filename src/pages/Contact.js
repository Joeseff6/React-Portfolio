      ...
      <div className="row">
        <div className="col-5 linkBox m-auto mb-3">
          ...
          <p><i className="fas fa-keyboard" /> Github:
            <a href="https://github.com/Joeseff6" target="_blank" rel="noreferrer"> https://github.com/Joeseff6</a>
          </p>
          <p><i className="fas fa-user-tie"></i> LinkedIn:
          <a href="https://www.linkedin.com/in/joseph-soria-5a335845/" target="_blank" rel="noreferrer"> https://www.linkedin.com/in/joseph-soria-5a335845/</a>
          </p>
